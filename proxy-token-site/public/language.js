(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "期权合约历史 OHLCV K线。默认 ThetaData Value，必要时回退 Alpaca。支持 OCC 或股票代码自动解析，并写入服务端缓存。": "Retrieve canonical 1Min historical OHLCV bars for OCC option contracts. The response reports provenance and may fall back to sparse traded activity; /v1/options/bars is a legacy alias. Server-side 5Min aggregation is not provided.",
