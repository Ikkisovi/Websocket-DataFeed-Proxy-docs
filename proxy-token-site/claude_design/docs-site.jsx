...
function SideNav({ tab }) {
  ...
  const sections = tab === "proxy" ? [
    ...
    { title: "Options Data", items: ["POST /v1/options/contracts", "POST /v1/options/snapshots", "POST /v1/options/snapshots/quote", "POST /v1/options/snapshots/open_interest", "POST /v1/options/snapshots/expiry", "POST /v1/history/options/bars", "POST /v1/options/open_interest", "POST /v1/options/eod"] },
